...
const BLOG = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'Chk Chk Boom',
      artist: 'Stray Kids',
      url: 'https://music.youtube.com/watch?v=eNPmM1DJQ8g&si=qK7vdbYL1oIbv4OG,
      cover:
        'https://lh3.googleusercontent.com/c4lz3mz-nPAX9JwUJlartDJeCFmiEglGKht6yQnNfD88zrmq5p7NKIfrZkUk88thaK79LvcFoPLGgBV1Nw=w544-h544-l90-rj'
    },
    {
      name: '王都グランセル',
